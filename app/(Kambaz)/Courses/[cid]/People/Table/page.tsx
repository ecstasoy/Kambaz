            ...
            <Table striped>
                ...
                <tbody>
                    ...
                    <tr>
                        <td className="wd-full-name text-nowrap">
                            <FaUserCircle className="me-2 fs-1 text-secondary" />
                            <span className="wd-first-name">Dr. Jane</span>{" "}
                            <span className="wd-last-name">Smith</span>
                        </td>
                        <td className="wd-login-id">faculty001</td>
                        <td className="wd-section">S101</td>
                        <td className="wd-role">FACULTY</td>
                        <td className="wd-last-activity">2020-10-05</td>
                        <td className="wd-total-activity">25:45:30</td>
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                            <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-login-id">ta001</td>
                        <td className="wd-section">S101</td>
                        <td className="wd-role">TA</td>
                        <td className="wd-last-activity">2020-10-04</td>
                        <td className="wd-total-activity">18:20:10</td>
                    </tr>
                </tbody>
            </Table>
        </div>
